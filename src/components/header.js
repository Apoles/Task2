...
export default function App() {
  ...
  return (
    <navbar className=' w-full flex flex-col'>
      <div className=' max-sm:space-x-4 max-sm:flex-row max-sm:items-center max-sm:justify-between  flex flex-row items-center justify-between px-4 py-6  w-full max-w-7xl mx-auto'>
        ...
        <div className='md:flex md:justify-between md:items-center md:w-full    '>
          <div
            className={`flex gap-4  max-sm:mb-5 font-medium text-base md:space-x-4 max-sm:hidden  md:mr-12  max-md:hidden `}
          >
            <div className=' '>
          ...
          <div className='  flex flex-row items-center space-x-8'>
            <a
              className='text-center rounded-md bg-white text-[#0A296C] border-[#D0D5DD] hover:bg-[#2445D8] hover:text-white transition-all border px-3.5 py-2  md:px-6 md:py-3.5 font-semibold text-base'
              href='#'
            >
              Giriş Yap
            </a>
            ...
            <a
              className='text-center rounded-md font-semibold text-base px-3.5 py-2  md:px-6 md:py-3.5 bg-[#2445D8] text-white hover:bg-[#2445D8]/90 transition-all'
              color='primary'
              href='#'
            >
              Hemen başvur
      ...
      <div
        ...
        } md:hidden max-w-7xl mx-auto gap-4  max-sm:mb-5 font-medium text-base   `}
      >
        <div className=''>
          <Link href='#' aria-current='page'>
            Anasayfa
